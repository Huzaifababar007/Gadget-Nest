...
const Cartitems = () => {
  const { cartItems, handleRemoveFromCart, handleCartQunatity } =
    useContext(Context);
      ...
      <div className="container">
        {cartItems.map((item) => (
          <div key={item.id} className="row gx-0">
            ...
            <div className="col-8">
              <div className="cartitem2 py-2">
                <h6 className="pb-2">{item.attributes.title}</h6>
                <img
